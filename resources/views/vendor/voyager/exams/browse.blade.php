                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="no-sort no-click bread-actions">
                                                <a class="btn btn-primary" target="_blank"
                                                    href="https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&u={{ route('start-exam', $data->uuid) }}&display=popup&ref=plugin&src=share_button"
                                                    style="margin-left: 2px;"> <i class="voyager-facebook"></i>
                                                    Share on
                                                    facebook</a>
                                    ...
                                    <li>
                                        <a class="btn btn-primary"
                                            href="{{ route('all-results-exam-pdf', $data->uuid) }}"
                                            style="margin-left: 2px;">Download Results</a>
                                    </li>
