...
<div style="background-color: #fff; position:relative">
    <div class="bg-success text-center pt-3" style="position:absolute; height:100%;width:140px;font-size:20px">Update</div>
    <p class="marquee pt-3 pb-5">
            ...
            <div id="carouselExampleDark" class="carousel carousel-dark slide mx-auto" data-bs-ride="carousel">
                ...
                <div class="carousel-inner ">
                    ...
                    <div class="carousel-item @if ($loop->first) active @endif">
                        <a href="{{ $exam->link }}">
                            <img class="d-block rounded slider-img" style="object-fit:contain;" height="300px" width="100%" src="{{ Voyager::image($exam->image) }}" alt="First slide">
                        </a>
                    </div>
                    @endforeach
                </div>
                @if (count($sliderExams) > 1)
                <button class="carousel-control-prev  " style="background:none;border:none" type="button" data-bs-target="#carouselExampleDark" data-bs-slide="prev">
                ...
                <button class="carousel-control-next" style="background:none;border:none" type="button" data-bs-target="#carouselExampleDark" data-bs-slide="next">
            ...
            <a href="{{ $course->link() }}" style="font-decoration:none">
                ...
                <div class="card package-hover shadow">
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-3">
                                <img src="{{ Voyager::image($course->thumbnail) }}" style="object-fit:fit;height:80px;width:80px" class="card-img-top border-rounded" alt="...">
                            </div>
        ...
        <div class="row py-5">
            ...
            <div class="col-md-3 col-12">
                ...
                <a class="btn btn-outline-danger d-block my-3 text-uppercase" href="javascript:void(0)" onclick="alert('আপনি এই প্যাকেজটিতে সাবস্ক্রাইব করেছেন ')">
                    সাবস্ক্রাইবড</a>
                @else
                <a class="btn btn-outline-danger d-block my-3 text-uppercase" href="{{ route('package-details', [Str::slug($package->title), $package]) }}">
                    বিস্তারিত
                    দেখুন</a>
                @endif
                @else
