                        ...
                        <div class="course-details-meta-list">
                           ...
                           <div class="align-self-center text-left">
                              <span class=" d-block">Minimum to pass : {{$exam->minimum_to_pass}}</span>
                               <span class=" d-block">Start date: {{ \Carbon\Carbon::parse($exam->to)->format('d M ,Y')}}</span>
                               <span class=" d-block">End date : {{ \Carbon\Carbon::parse($exam->to)->format('d M ,Y')}}</span>
                                ...
                                <div class="col-md-6 mt-4 mt-md-0 ">
                                        ...
                                        <div class="align-self-center text-right">
                                            <span class=" d-block">Full-mark : {{$exam->point}}</span>
                                            <span class="d-block">The value of individual questions: 1</span>
                            ...
                            <div class="col-6 mt-2">
                                <div class="card single-course-inner">
                                    <form action="">
                                        ...
                                        <h4 class="card-title bg-success text-white fw-semibold py-3 pl-4"> <span>{{$loop-> iteration }}.</span> {{$question->title}}</h4>
                                        <div class="d-flex flex-wrap mb-5">
                                            @foreach($question->choices as $choice)
                                            <div class="form-check col-3">
                                                <input class="form-check-input ml-1 mt-2" type="radio" value="" name="choice" id="choice">
                                                <label class="form-check-label queston ml-4" for="choice">
                                                    {{$choice->choice}}
                                                </label>
                                            </div>
                                            @endforeach
