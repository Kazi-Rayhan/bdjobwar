                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('resetOtpCheck') }}">
                        ...
                        <div class="row mb-4 px-4 pt-4">
                            ...
                            <div class="col-md-12">
                                <input id="otp" placeholder="Please write your OTP" type="number" class="form-control py-2 @error('otp') is-invalid @enderror" name="otp" autocomplete="otp" autofocus>
                        ...
                        <div class="row mb-0">
                            ...
                            <div class="col-5 ">
                             <a class="btn btn-success px-3"  href="{{route('password.request')}}">Send OTP</a>
                            </div>
                        </div>
                    </form>
                </div>
